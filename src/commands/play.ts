import { onFinishCommand } from './../utils/onFinish';
...
export const playMusicCore = async (interaction: Discord.Interaction, db: RedisLogic, connections: Map<string, Discord.VoiceConnection>, channel: Discord.VoiceChannel, url: string) => {
